	...
	<footer id="colophon" class="site-footer" role="contentinfo">
    	...
    	<div class="ak-container">
                ...
                <div class="site-info">
                    ...
                    <?php esc_html_e('WordPress Theme','the-launcher');?> : <a target="_blank" href="<?php echo esc_url('https://accesspressthemes.com/wordpress-themes/the-launcher/'); ?>">The-Launcher</a>
                    <?php esc_html_e( 'by AccessPress Themes', 'the-launcher' ); ?>
                    </span>
            	</div><!-- .site-info -->
    	</div><!-- ak-container-->
	</footer><!-- #colophon -->
